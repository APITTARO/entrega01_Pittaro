...
def template(self):
    html = open("C:\\Users\\agus-\\Desktop\\python\\django\\nuevo_proyecto\\entrega01_pittaro\\AppCoder\\plantillas\\template.html")
...
def plantilla1(self):
    ...
    hijos= Hijos.objects.all()
    diccionario = {'familiares': familiares, 'tipofamiliares': tipofamiliares, 'hijos': hijos}
